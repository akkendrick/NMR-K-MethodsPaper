...
KfactorCutoff = 10;
SDR_numBelow = sum(plottedSDRerrorFactor < 10)
SOE_numBelow = sum(plottedSOEerrorFactor < 10)
Seevers_numBelow = sum(plottedSeeverserrorFactor < 10)
KGM_numBelow = sum(plottedKGMerrorFactor < 10)
