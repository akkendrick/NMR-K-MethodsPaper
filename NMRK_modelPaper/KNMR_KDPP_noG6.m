% Make NMR K vs  DPP K plot w/o G6
clear
close all
...
m = 1;
n = 2;
siteList = [{"Site1-WellG5"},{"Site2-WellPN1"},{"Site2-WellPN2"}];
...
legend('SDR','Seevers','KGM','SOE','TC 33 ms cutoff','5*10^{-5} m/s line','Location','northwest')
ylim([5*10^-8,1*10^0])
xlabel('DPP K (m/s)')
