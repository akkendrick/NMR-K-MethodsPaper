function plotWellProfiles_NMR_DPP(waterTable,z,T2dist,T2logbins,...
    DPPdat, SDR_K_all, SDR_K_best, plotNum, fig, coreSampleLoc) 
...
%     end
    ...
    plot(SDR_K_best, DPP_depths,'.','parent',ax1,'MarkerSize',24,'Color', [0, 0.4470, 0.7410])

    
    for j = 1:length(SDR_K_all)
            plot(SDR_K_all{j}, DPP_depths,'.','parent',ax1,'MarkerSize',4,'Color',[17 17 17]/255)
    end
