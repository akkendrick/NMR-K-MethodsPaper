function plotWellProfiles_wRho(waterTable,z,T2dist,T2logbins,...
    DPPdat, SDR_K_all, SDR_K_best, plotNum, fig, coreSampleLoc, rhoDepths, rhoVal) 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%    
    ...
    if plotNum <= 6
        plot(rhoVal,rhoDepths,'.','MarkerSize',15)
       
    end
    
    xlabel(strcat('\rho Values from G7', '\rm (um/s)'))
    set(gca, 'YDir','reverse')
