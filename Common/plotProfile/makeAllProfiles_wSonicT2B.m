...
% sites = {'Site2-WellPN1','Site2-WellPN2'};
% figNames = {'Plainfield Lake PN1','Plainfield Lake PN2'}
% 
% gammaNames = {'Site2-Well1-gamma-EMI-bLS.csv','Site2-Well2-gamma-EMI-bLS.csv'};
...
%     T2dist = T2dist(:,2:end);
    ...
    plotWellProfiles_wSonicT2B(figName,waterTable(jj),z,T2dist,T2logbins,DPPdat,SDR_K_all, SDR_K_best, plotNum, f1, sonicCoreT2BData)
