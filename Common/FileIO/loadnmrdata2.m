...
%         SumEch_twm_3s = d(:,8); 
    ...
    elseif strcmp(name, 'A1') ==1 
        str = ['..' filesep 'Field Data' filesep 'dpnmr_site_' name];
        try
            load(str) 
        catch
            keyboard;
        ...
        str2 = ['..' filesep 'Field Data' filesep 'Aggregated_data' filesep 'dpnmrA11.txt']; 
        try
            d2 = load(str2);
        catch
            keyboard; 
        ...
        SumEch_twm1 = d2(:,7); 
        SumEch_twm_3s1 = d2(:,8); 
        str3 = ['..' filesep 'Field Data' filesep 'Aggregated_data' filesep 'dpnmrA12.txt'];
        d3 = load(str3);
