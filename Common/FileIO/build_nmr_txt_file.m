...
in1 = [baseDir site '/' name '_SE_decay' '.txt']; 
in2 = [baseDir site '/' name '_1Dvectors.txt'];
in3 = [baseDir site '/' strcat(name,'_DPP_filt.txt')];
in4 = [baseDir site '/'  name '_SE_decay_time.txt'];
