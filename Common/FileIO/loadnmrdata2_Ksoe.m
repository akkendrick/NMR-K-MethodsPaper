function [d, K, T2ML, phi, z, SumEch, K_SOE, log10K, log10T2, log10Porosity, SumEch_3s, SumEch_twm, SumEch_twm_3s] = loadnmrdata2_Ksoe(name)
...
%         log10K = log10(K); 
    ...
    elseif strcmp(name, 'all_data') == 1
        [~, Dkg, T2MLg, phig, zg, SumEchg, ~, ~, ~, SumEch_3sg, ...
            SumEch_twmg, SumEch_twm_3sg] = loadnmrdata2_Ksoe('gems_all');
        [~, Dklar, T2MLlar, philar, zlar, SumEchlar, ~, ~, ~, SumEch_3slar, ...
            SumEch_twmlar, SumEch_twm_3slar] = loadnmrdata2_Ksoe('dpnmr_larned_all');
        [~, Dkleq, T2MLleq, phileq, zleq, SumEchleq, ~, ~, ~, SumEch_3sleq, ...
            SumEch_twmleq, SumEch_twm_3sleq] = loadnmrdata2_Ksoe('dpnmr_leque_all');
